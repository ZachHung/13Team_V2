    ...
    <div className='listUsersAdminTitle d-flex flex-column'>
      <div className='p-3'>
        <div className='d-flex align-items-center mb-4 qlsp'>
          <h1 className='mr-3 fw-bold UserTitle'>
            <FontAwesomeIcon icon={faUserAlt}></FontAwesomeIcon> Quản lý người
            dùng
          </h1>
          ...
          <button
            className='btnDeleteAllUsers btn btn-danger'
          ...
          <h2 className='fw-bold totalCountPur'>
            (<FontAwesomeIcon icon={faUserAlt}></FontAwesomeIcon> Tất cả:{" "}
      ...
      <div className='divCustomBtn'>
        ...
        <button
          ...
          onClick={() => handleChangeUsersPerPage()}
        >
          OK
        </button>
        <br></br>
        ...
        <button
          className='myCustomBtn btn btn-outline-primary'
          onClick={(e) => handleGoToUsersPageNum(e)}
        >
          OK
        </button>
      </div>
