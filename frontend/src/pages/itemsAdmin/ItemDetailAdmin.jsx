...
//       if (confirmDelete){
//       axios.delete(`http://localhost:5000/api/admin/products/delete/${id}`).then((res) =>{
//         console.log (res.data);
//         setItemList (res.data.items);  
//       });
...
//             <h1 className="mr-3 fw-bold">Chi tiết sản phẩm</h1>
//           </div>
...
//                   <td>
//                     <a href={`/admin/products/detail/${item._id}`} className="linkToItem">
//                       {item.name}
//                     </a>
//                   </td>
