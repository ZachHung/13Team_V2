              ...
              <ul className='glide__slides'>
                  ...
                  <div className='spotlight grid-col-1-2-1'>
                    <div className='grid-col-1'>
                      <div className='spotlight__item'>
                        <img
                          src={`${process.env.REACT_APP_SERVER_PATH}/image/landing_page/slide2/asus-rog-phone-5s.jpg`}
                          alt='Ảnh sản phẩm'
                        />
                      ...
                      <div className='spotlight__item'>
                        <img
                          src={`${process.env.REACT_APP_SERVER_PATH}/image/landing_page/slide2/xiaomi-mi-11.png`}
                          alt='Ảnh sản phẩm'
                        />
                    ...
                    <div className='spotlight__item'>
                      <img
                        src={`${process.env.REACT_APP_SERVER_PATH}/image/landing_page/slide2/samsung-galaxy-s21-ultra.jpg`}
                        alt='Samsung Week'
                      />
                    ...
                    <div className='grid-col-1'>
                      <div className='spotlight__item'>
                        <img
                          src={`${process.env.REACT_APP_SERVER_PATH}/image/landing_page/slide2/redmi-k40.jpg`}
                          alt='Ảnh sản phẩm'
                        />
                      ...
                      <div className='spotlight__item'>
                        <img
                          src={`${process.env.REACT_APP_SERVER_PATH}/image/landing_page/slide2/iphone-11-pro-max-trang.jpg`}
                          alt='Ảnh sản phẩm'
                        />
                ...
                <li className='glide__slide'>
                  <div className='spotlight grid-col-1-1-2'>
                    <div className='grid-col-1'>
                      <div className='spotlight__item'>
                        <img
                          src={`${process.env.REACT_APP_SERVER_PATH}/image/landing_page/slide2/acer-aspire-7-a715.jpg`}
                          alt='Ảnh sản phẩm'
                        />
                      ...
                      <div className='spotlight__item'>
                        <img
                          src={`${process.env.REACT_APP_SERVER_PATH}/image/landing_page/slide2/acer-aspire-a315.jpg`}
                          alt='Ảnh sản phẩm'
                        />
                    ...
                    <div className='grid-col-1'>
                      ...
                      <div className='spotlight__item'>
                        <img
                          src={`${process.env.REACT_APP_SERVER_PATH}/image/landing_page/slide2/macbook-air-m1-2020.jpg`}
                          alt='Ảnh sản phẩm'
                        />
                    ...
                    <div className='spotlight__item'>
                      <img
                        src={`${process.env.REACT_APP_SERVER_PATH}/image/landing_page/slide2/acer-nitro-5.jpg`}
                        alt='Ảnh sản phẩm'
                      />
                ...
                <li className='glide__slide'>
                  <div className='spotlight grid-col-1-1-1'>
                    <div className='spotlight__item'>
                      <img
                        src={`${process.env.REACT_APP_SERVER_PATH}/image/landing_page/slide2/ipad-mini-6.png`}
                        alt='Ảnh sản phẩm'
                      />
                    ...
                    <div className='spotlight__item mobile-hiden'>
                      <img
                        src={`${process.env.REACT_APP_SERVER_PATH}/image/landing_page/slide2/ipad-pro-2021.png`}
                        alt='Ảnh sản phẩm'
                      />
                    ...
                    <div className='spotlight__item mobile-hiden'>
                      <img
                        src={`${process.env.REACT_APP_SERVER_PATH}/image/landing_page/slide2/samsung-galaxy-tab-s7.png`}
                        alt='Ảnh sản phẩm'
                      />
                ...
                <li className='glide__slide'>
                  <div className='spotlight grid-col-1-1'>
                    <div className='spotlight__item'>
                      <img
                        src={`${process.env.REACT_APP_SERVER_PATH}/image/landing_page/slide2/jbl_450_black.webp`}
                        alt='Ảnh sản phẩm'
                      />
