    ...
    return (
        <div className="container mt-4 mb-4">
            ...
            <form className="mt-4" method="POST" action={URL + "admin/orders/update/" + purchase._id}>
                ...
                <div className="mb-4">
                    <label className="form-label lable_level_1">Mã khách hàng</label>
                    <input disabled type="text" className="form-control my-input-tag" defaultValue={purchase.userID} />
                </div>
                <div className="mb-4">
                    <label htmlFor="status" className="form-label lable_level_1">Trạng thái đơn hàng</label>
                    <select class="form-select my-input-tag" name='status'>
                ...
                <label htmlFor="status" className="form-label lable_level_1">Chi tiết đơn hàng</label>
                {
                    purchase.list?.map((list) => (
                        <div >
                            <div className="mb-4">
                                <label className="form-label lable_level_2">Mã sản phẩm</label>
                                <input disabled type="text" className="form-control my-input-tag" defaultValue={list.optionID} />
                            </div>
                            <div class="lavel_2">
                                <div className="mb-4">
                                    <label htmlFor="color" className="form-label lable_level_3">Màu sắc</label>
                                    <input disabled type="text" className="form-control my-input-tag" defaultValue={list.color} />
                                </div>
                                <div className="mb-4">
                                    <label htmlFor="quantity" className="form-label lable_level_3">Số lượng</label>
