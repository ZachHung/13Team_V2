          ...
          <form className='mt-4'>
            ...
            <div className='mb-4'>
              ...
              <input
                ...
                type='text'
                className='form-control my-input-tag'
                defaultValue={purchase.userID}
              />
            </div>
            <div className='mb-4'>
              <label htmlFor='status' className='form-label label_level_1'>
                Trạng thái đơn hàng
              </label>
              <select
              ...
              <div>
                <div className='mb-4'>
                  ...
                  <input
                    ...
                    type='text'
                    className='form-control my-input-tag'
                    defaultValue={list.optionID.item.name}
                  />
                </div>
                <div className='lavel_2'>
                  <div className='mb-4'>
                    <label htmlFor='color' className='form-label label_level_3'>
                      Màu sắc
                    </label>
                    <input
                      disabled
                  ...
                  <div className='mb-4'>
                    ...
                    <input
                      ...
                      type='text'
                      className='form-control my-input-tag'
                      defaultValue={list.optionID.detail}
                    />
                  </div>
                  <div className='mb-4'>
                    <label
            ...
            <button className='btn btn-primary my-bnt' onClick={handleSubmit}>
              Lưu lại
            </button>
          </form>
        </div>
