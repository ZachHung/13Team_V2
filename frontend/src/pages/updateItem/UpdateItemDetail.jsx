    ...
    return (
        <div className="container mt-4 mb-4">
            ...
            {ItemDetail.map((ItemDetail) => (
                <div>
                    <h1 class="text-center heading">Chỉnh sửa thông tin chi tiết sản phẩm {ItemDetail.name}</h1>
                    {ItemDetail.slug?.map((slug, index) => (
                        <div>
                            <form className="mt-4" method="POST" action={URL + "admin/products/updateDetail/" + slug._id}>
                                <div>
                                    {/* <div className="mb-4">
                                    <label htmlFor="slug" className="form-label lable_level_1">Slug</label>
                                    ...
                                    <div className="mb-4">
                                        <label htmlFor="detail" className="form-label lable_level_1">Bộ nhớ trong</label>
                                        <input className="form-control my-input-tag" id="detail" name="detail" defaultValue={slug.detail} />
                                    </div>

                                    <label className="lable_level_1">Màu sắc <a onClick={myFunction.bind(this, index)} id='add-color' className="btn btn-primary addbnt">+</a></label>
                                    <p className='decri'>Xóa tên màu để xóa màu và thông tin liên quan đến màu đó</p>

                                    {slug.color?.map(color => (
                                        <div>
                                            <label className="lable_level_2">Màu</label>
                                            ...
                                            <div className='lavel_2'>
                                                ...
                                                <div className="mb-4">
                                                    <label htmlFor="image" className="form-label lable_level_3">Hình ảnh</label>
                                    ...
                                    <div id="my-color" className="add-info my-color-hidden">
                                        ...
                                        <div className='lavel_2'>
                                            ...
                                            <div className="mb-4">
                                                <label htmlFor="image" className="form-label lable_level_3">Hình ảnh</label>
                                                <input placeholder='Nhập vào đường dẫn' className="form-control my-input-tag image-new" id="image-new" />
                                            </div>
