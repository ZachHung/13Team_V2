    ...
    <div className='container'>
      ...
      <form id='createPhoneinfo'>
        <div className='form-group'>
          ...
          <label className='form-label' name='slug'>
            Slug
          </label>
          <input
            type='text'
        ...
        <label className='form-label label-select my-input-tag'>
          Loại sản phẩm{" "}
        </label>
        <select
          className='type_device my-input-tag'
          name='type'
          id='type'
        ...
        <div className='mb-4 mt-4'>
          <div className='row'>
            ...
            <div className='col'>
              <a className='btn btn-primary upload-bnt' onClick={handleUpload}>
                Tải lên
              </a>
            </div>
          </div>
